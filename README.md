...
- `packages/warm-meow-morandi-v0.3.11.codexskin-theme` — ready-to-install theme package.
...
```bash
node <toolkit>/scripts/codexskin.mjs install packages/warm-meow-morandi-v0.3.11.codexskin-theme
